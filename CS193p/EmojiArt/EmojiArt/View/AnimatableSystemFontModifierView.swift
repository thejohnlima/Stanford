...
// ViewModifier to set the font to the system font of a given size
// (and weight and design)
// Changes to the size can be animated

struct AnimatableSystemFontModifierView: AnimatableModifier {
  var size: CGFloat
...
extension View {
  func font(animatableWithSize size: CGFloat, weight: Font.Weight = .regular, design: Font.Design = .default) -> some View {
    self.modifier(AnimatableSystemFontModifierView(size: size, weight: weight, design: design))
  }
}
